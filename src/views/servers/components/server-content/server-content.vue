<template>
  <VueDragSplit ref="vueDragSplitRef" v-model:windowListSync="windowList" v-model:activeTabKeySync="activeTabKey" :generateWindowConfig="generateWindowConfig" @closeWindow="onCloseWindow" @resize="onResize" @dragEnd="onDragend">
